...
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Schreibtischlade', 1, @schreibtischId);
SET @d1Id = (SELECT id FROM drawer WHERE name ='Schreibtischlade');
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Drawer2', 2, @schreibtischId);
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Drawer3', 1, @shelf2Id);
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Drawer4', 2, @shelf2Id);
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Drawer5', 2, @shelf3Id);
INSERT INTO drawer (name, DRAWER_ORDER, shelf_id) VALUES ('Drawer6', 1, @shelf3Id);
